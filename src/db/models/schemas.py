...
from sqlalchemy import String, Integer, Boolean, Float, ForeignKey, LargeBinary, Enum as SQLEnum
...
class Order(Base):
    ...
    def __init__(self, user, status: OrderStatus = OrderStatus.PENDING, price=0):
